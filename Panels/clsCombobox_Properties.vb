Public Class Combobox_Properties
    Inherits UserControl

    Friend WithEvents Combobox1 As ComboBox
    Friend WithEvents Label1 As Label

    Public Sub New(txtLabelText As String, txtDefaultValue As String, ParamArray Values() As String)
        InitializeComponent()
        Label1.Text = txtLabelText
        Combobox1.Items.AddRange(Values)
        Combobox1.Text = txtDefaultValue
    End Sub
    ...
    Private Sub InitializeComponent()
        ...
        Me.Combobox1.Name = "Combox1"
        Me.Combobox1.Size = New System.Drawing.Size(250, 27)
        ...
        Me.Name = "Combobox_Properties"
        Me.Size = New System.Drawing.Size(256, 68)
        Me.ResumeLayout(False)
        Me.PerformLayout()

    End Sub
    Private Sub txtDescription_KeyDown(sender As Object, e As KeyEventArgs) Handles Combobox1.KeyDown
